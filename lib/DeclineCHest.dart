...
void main() => runApp(const declinechest());

class declinechest extends StatelessWidget {
  const declinechest({super.key});
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      ...
      home: declinechestscreen(),
    );
  }
}

class declinechestscreen extends StatefulWidget {
  const declinechestscreen({super.key});

  @override
  State<declinechestscreen> createState() => _declinechestscreenState();
}

class _declinechestscreenState extends State<declinechestscreen> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(
      'https://res.cloudinary.com/dg6kx8vbj/video/upload/c_fit,w_1419/v1683983222/workouts/Chest/decline_dumbell_press_hewwgc.mp4',
    ));
