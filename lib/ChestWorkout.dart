import 'package:fitnessapp/ChestMachine.dart';
import 'package:fitnessapp/InclineChest.dart';
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => inclinechestscreen()));
                },
                child: Container(
                  child: Center(
                    child: Row(
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => flatchestscreen()));
                },
                child: Container(
                  child: Center(
                    child: Row(
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => declinechestscreen()));
                },
                child: Container(
                  child: Center(
                    child: Row(
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => chestdipsscreen()));
                },
                child: Container(
                  child: Center(
                    child: Row(
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => chestmachinescreen()));
                },
                child: Container(
                  child: Center(
                    child: Row(
