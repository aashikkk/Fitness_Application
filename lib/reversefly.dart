...
void main() => runApp(const reversefly());

class reversefly extends StatelessWidget {
  const reversefly({super.key});
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      ...
      home: reverseflyscreen(),
    );
  }
}

class reverseflyscreen extends StatefulWidget {
  const reverseflyscreen({super.key});

  @override
  State<reverseflyscreen> createState() => _reverseflyscreenState();
}

class _reverseflyscreenState extends State<reverseflyscreen> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(
      'https://res.cloudinary.com/dg6kx8vbj/video/upload/c_fit,w_1419/v1684159942/vecteezy_dumbbell-reverse-fly-fitness-exercise-workout-animation_20939626_744_naz2hg.mp4',
    ));
