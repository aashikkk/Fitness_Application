...
class lungesscreen extends StatefulWidget {
  const lungesscreen({super.key});

  @override
  State<lungesscreen> createState() => _lungesscreenState();
}

class _lungesscreenState extends State<lungesscreen> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(
      'https://res.cloudinary.com/dg6kx8vbj/video/upload/c_fit,w_1419/v1684686767/vecteezy_barbell-front-lunges-with-small-pause-fitness-exercise_23272652_954_vicyig.mp4',
    ));
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: getwidth(context),
              child: Text(
                'Lunges use large lower-body muscles, including the glutes, hamstrings, and quadriceps. This strength-building move can help correct muscle imbalances, increase flexibility, and boost metabolism. Forward lunges are the most common style of this exercise.',
                style: TextStyle(
