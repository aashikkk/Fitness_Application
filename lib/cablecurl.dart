...
void main() => runApp(const cablecurl());
...
class cablecurl extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      ...
      home: cablecurlscreen(),
    );
  }
}

class cablecurlscreen extends StatefulWidget {
  const cablecurlscreen({super.key});

  @override
  State<cablecurlscreen> createState() => _cablecurlscreenState();
}

class _cablecurlscreenState extends State<cablecurlscreen> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(
      'https://res.cloudinary.com/dg6kx8vbj/video/upload/c_fit,w_1419/v1684159855/vecteezy_cable-biceps-curl-ez-bar-fitness-exercise-workout-animation_23550765_317_xzr0so.mp4',
    ));
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: getwidth(context),
              child: Text(
                'Cable curls strengthen your biceps almost better than any other biceps exercise. If you are looking to increase the size or strength of your biceps muscles, consider adding cable curls to your routine.',
                style: TextStyle(
