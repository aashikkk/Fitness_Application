          ...
          IconButton(
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => chest_workout()));
              },
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (inclineweightController.text
                                              .toString()
                                              .isEmpty ||
                                          inclinesetsController.text
                                              .toString()
                                              .isEmpty ||
                                          inclinerepsController.text
                                              .toString()
                                              .isEmpty) {
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (flatweightController.text
                                              .toString()
                                              .isEmpty ||
                                          flatsetsController.text
                                              .toString()
                                              .isEmpty ||
                                          flatrepsController.text
                                              .toString()
                                              .isEmpty) {
                                        toast('All Fields are required');
                                      } else {
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (declineweightController.text
                                              .toString()
                                              .isEmpty ||
                                          declinesetsController.text
                                              .toString()
                                              .isEmpty ||
                                          declinerepsController.text
                                              .toString()
                                              .isEmpty) {
                                        toast('All Fields are required');
                                      } else {
                                        ref
                                            .child(
                                                UserRecords().Userid.toString())
                                            .update({
                                          'Decline bench press weights':
                                              declineweightController.text
                                                  .toString(),
                                          'Decline bench press sets':
                                              declinesetsController.text
                                                  .toString(),
                                          'Decline bench press reps':
                                              declinerepsController.text
                                                  .toString(),
                                        }).then((value) {
                                          toast('Workout Tracked');
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (machineweightController.text
                                              .toString()
                                              .isEmpty ||
                                          machinesetsController.text
                                              .toString()
                                              .isEmpty ||
                                          machinerepsController.text
                                              .toString()
                                              .isEmpty) {
                                        toast('All Fields are required');
                                      } else {
                                        ref
                                            .child(
                                                UserRecords().Userid.toString())
                                            .update({
                                          'Chest Machine press weights':
                                              machineweightController.text
                                                  .toString(),
                                          'Chest Machine press sets':
                                              machinesetsController.text
                                                  .toString(),
                                          'Chest Machine press reps':
                                              machinerepsController.text
                                                  .toString(),
                                        }).then((value) {
                                          toast('Workout Tracked');
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (dipsweightController.text
                                              .toString()
                                              .isEmpty ||
                                          dipssetsController.text
                                              .toString()
                                              .isEmpty ||
                                          dipsrepsController.text
                                              .toString()
                                              .isEmpty) {
                                        toast('All Fields are required');
                                      } else {
