          ...
          IconButton(
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => arms_workout()));
              },
                ...
                children: [
                  ...
                  Container(
                    child: CircleAvatar(
                      backgroundColor: Colors.black,
                      backgroundImage:
                          AssetImage("assets/images/cablecurl.png"),
                      radius: 35,
                    ),
                    margin: EdgeInsets.only(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (cablebicepweightController.text
                                              .toString()
                                              .isEmpty ||
                                          cablebicepsetsController.text
                                              .toString()
                                              .isEmpty ||
                                          cablebiceprepsController.text
                                              .toString()
                                              .isEmpty) {
                                        ...
                                        ref
                                            ...
                                            .update({
                                          'Cable Bicep weights':
                                              cablebicepweightController.text
                                                  .toString(),
                                          'Cable Bicep sets':
                                              cablebicepsetsController.text
                                                  .toString(),
                ...
                children: [
                  ...
                  Container(
                    child: CircleAvatar(
                      backgroundColor: Colors.black,
                      backgroundImage:
                          AssetImage("assets/images/bicepscurl.png"),
                      radius: 35,
                    ),
                    margin: EdgeInsets.only(
                        top: getheight(context) * 0.01,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (dumbellbicepweightController.text
                                              .toString()
                                              .isEmpty ||
                                          dumbellbicepsetsController.text
                                              .toString()
                                              .isEmpty ||
                                          dumbellbiceprepsController.text
                                              .toString()
                                              .isEmpty) {
                                        toast('All Fields are required');
                                      } else {
                                        ref
                                          ...
                                          'Dumbbell Curl weights':
                                              dumbellbicepweightController.text
                                                  .toString(),
                                          'Dumbbell Curl sets':
                                              dumbellbicepsetsController.text
                                                  .toString(),
                ...
                children: [
                  ...
                  Container(
                    child: CircleAvatar(
                      backgroundColor: Colors.black,
                      backgroundImage:
                          AssetImage("assets/images/barbellseated.png"),
                      radius: 35,
                    ),
                    margin: EdgeInsets.only(
                        top: getheight(context) * 0.01,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (barbellcurlweightController.text
                                              .toString()
                                              .isEmpty ||
                                          barbellcurlsetsController.text
                                              .toString()
                                              .isEmpty ||
                                          barbellcurlrepsController.text
                                              .toString()
                                              .isEmpty) {
                                        toast('All Fields are required');
                                      } else {
                                        ref
                                          ...
                                          'Barbell Curl weights':
                                              barbellcurlweightController.text
                                                  .toString(),
                                          'Barbell Curl sets':
                                              barbellcurlsetsController.text
                                                  .toString(),
                ...
                children: [
                  ...
                  Container(
                    child: CircleAvatar(
                      backgroundColor: Colors.black,
                      backgroundImage:
                          AssetImage("assets/images/dipsmachine.png"),
                      radius: 35,
                    ),
                    margin: EdgeInsets.only(
                        top: getheight(context) * 0.01,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (machinedipsweightController.text
                                              .toString()
                                              .isEmpty ||
                                          machinedipssetsController.text
                                              .toString()
                                              .isEmpty ||
                                          machinedipsrepsController.text
                                              .toString()
                                              .isEmpty) {
                                        toast('All Fields are required');
                                      } else {
                                        ref
                                            .child(
                                                UserRecords().Userid.toString())
                                            .update({
                                          'Machine Dips weights':
                                              machinedipsweightController.text
                                                  .toString(),
                                          'Machine Dips sets':
                                              machinedipssetsController.text
                                                  .toString(),
                ...
                children: [
                  ...
                  Container(
                    child: CircleAvatar(
                      backgroundColor: Colors.black,
                      backgroundImage:
                          AssetImage("assets/images/benchdips.png"),
                      radius: 35,
                    ),
                    margin: EdgeInsets.only(
                        top: getheight(context) * 0.01,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (benchdipsweightController.text
                                              .toString()
                                              .isEmpty ||
                                          benchdipssetsController.text
                                              .toString()
                                              .isEmpty ||
                                          benchdipsrepsController.text
                                              .toString()
                                              .isEmpty) {
                                        toast('All Fields are required');
                                      } else {
                                        ref
                                            ...
                                            .update({
                                          'Bench Dips weights':
                                              benchdipsweightController.text
                                                  .toString(),
                                          'Bench Dips sets':
                                              benchdipssetsController.text
                                                  .toString(),
