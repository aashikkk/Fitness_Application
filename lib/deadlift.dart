...
void main() => runApp(const deadlift());
...
class _deadliftscreenState extends State<deadliftscreen> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(
      'https://res.cloudinary.com/dg6kx8vbj/video/upload/c_fit,w_1419/v1684058598/vecteezy_barbell-stiff-leg-deadlift-fitness-exercise-workout_23272600_873_nnuewa.mp4',
    ));
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: getwidth(context),
              child: Text(
                'The deadlift is an effective exercise for building muscle in the upper and lower body. As a result, it can help improve overall strength and athleticism. Increasing muscle mass can also increase a person metabolism.',
                style: TextStyle(
