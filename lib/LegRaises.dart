...
void main() => runApp(const legraises());
...
class _legraisesscreenState extends State<legraisesscreen> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(
      'https://res.cloudinary.com/dg6kx8vbj/video/upload/c_fit,w_1419/v1684679149/vecteezy_alternate-leg-raise-from-reverse-plank-position-fitness_23550606_726_ckztnu.mp4',
    ));
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: getwidth(context),
              child: Text(
                'Leg lifts can strengthen your entire core, which includes: Your abdominal muscles, including the “six-pack” of abs in the front and the muscles along the sides of your body. The muscles in your back, including the ones between your spine bones and those that run along your spine.',
                style: TextStyle(
