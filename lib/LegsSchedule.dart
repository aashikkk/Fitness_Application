          ...
          IconButton(
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => legs_workout()));
              },
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (legpressweightController.text
                                              .toString()
                                              .isEmpty ||
                                          legpresssetsController.text
                                              .toString()
                                              .isEmpty ||
                                          legpressrepsController.text
                                              .toString()
                                              .isEmpty) {
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (squatsweightController.text
                                              .toString()
                                              .isEmpty ||
                                          squatssetsController.text
                                              .toString()
                                              .isEmpty ||
                                          squatsrepsController.text
                                              .toString()
                                              .isEmpty) {
                                        toast('All Fields are required');
                                      } else {
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (lungesweightController.text
                                              .toString()
                                              .isEmpty ||
                                          lungessetsController.text
                                              .toString()
                                              .isEmpty ||
                                          lungesrepsController.text
                                              .toString()
                                              .isEmpty) {
                                        toast('All Fields are required');
                                      } else {
                ...
                children: [
                  ...
                  Container(
                    child: CircleAvatar(
                      backgroundColor: Colors.black,
                      backgroundImage:
                          AssetImage("assets/images/legextension.png"),
                      radius: 35,
                    ),
                    margin: EdgeInsets.only(
                        top: getheight(context) * 0.01,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (legextensionweightController.text
                                              .toString()
                                              .isEmpty ||
                                          legextensionsetsController.text
                                              .toString()
                                              .isEmpty ||
                                          legextensionrepsController.text
                                              .toString()
                                              .isEmpty) {
                                        toast('All Fields are required');
                                      } else {
                                        ref
                                            .child(
                                                UserRecords().Userid.toString())
                                            .update({
                                          'Legs Extension weights':
                                              legextensionweightController.text
                                                  .toString(),
                                          'Legs Extension sets':
                                              legextensionsetsController.text
                                                  .toString(),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (calvesweightController.text
                                              .toString()
                                              .isEmpty ||
                                          calvessetsController.text
                                              .toString()
                                              .isEmpty ||
                                          calvesrepsController.text
                                              .toString()
                                              .isEmpty) {
                                        toast('All Fields are required');
                                      } else {
                                        ref
                                            .child(
                                                UserRecords().Userid.toString())
                                            .update({
                                          'Calve Raises weights':
                                              calvesweightController.text
                                                  .toString(),
                                          'Calve Raises sets':
                                              calvessetsController.text
                                                  .toString(),
