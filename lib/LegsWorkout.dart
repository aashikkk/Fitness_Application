import 'package:fitnessapp/squats.dart';
          ...
          child: Column(
            children: [
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => legpressscreen()));
                },
                child: Container(
                  child: Center(
                    child: Row(
                      ...
                      children: [
                        CircleAvatar(
                          backgroundColor: Colors.black,
                          backgroundImage:
                              AssetImage("assets/images/legpress.png"),
                          radius: 40,
                        ),
                        Container(
              ...
              InkWell(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => lungesscreen()));
                },
                child: Container(
                  child: Center(
                    child: Row(
                      ...
                      children: [
                        CircleAvatar(
                          backgroundColor: Colors.black,
                          backgroundImage:
                              AssetImage("assets/images/lunges.png"),
                          radius: 40,
                        ),
                        Container(
                          width: getwidth(context) * 0.4,
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => legsextensionscreen()));
                },
                child: Container(
                  child: Center(
                    child: Row(
              ...
              InkWell(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => calvesscreen()));
                },
                child: Container(
                  child: Center(
                    child: Row(
                      ...
                      children: [
                        CircleAvatar(
                          backgroundColor: Colors.black,
                          backgroundImage:
                              AssetImage("assets/images/calve.png"),
                          radius: 40,
                        ),
                        Container(
                          width: getwidth(context) * 0.4,
