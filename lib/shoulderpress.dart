...
void main() => runApp(const shoulderpress());
...
class _shoulderpressscreenState extends State<shoulderpressscreen> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(
      'https://res.cloudinary.com/dg6kx8vbj/video/upload/c_fit,w_1419/v1684159925/vecteezy_dumbbell-seated-shoulder-press-fitness-exercise-workout_20939621_728_wlwwdt.mp4',
    ));
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: getwidth(context),
              child: Text(
                'The shoulder press is one of the best exercises for strengthening your shoulders and upper back. The biggest benefactor of the shoulder press is the front portion of your shoulder muscle (anterior deltoid) but you will also be working out your deltoids, triceps, trapezius and pecs.',
                style: TextStyle(
