...
void main() => runApp(const pullups());
...
class pullupsscreen extends StatefulWidget {
  const pullupsscreen({super.key});

  @override
  State<pullupsscreen> createState() => _pullupsscreenState();
}
...
class _pullupsscreenState extends State<pullupsscreen> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(
      'https://res.cloudinary.com/dg6kx8vbj/video/upload/c_fit,w_1419/v1684059911/vecteezy_assisted-pull-up-fitness-exercise-workout-animation-video_23550664_861_ddks3z.mp4',
    ));
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: getwidth(context),
              child: Text(
                'weighted pull-ups are among the most effective exercises for developing size and strength in the muscles of the upper body. So much so, in fact, that they are considered essential in many athletic or hybrid calisthenic training programs.',
                style: TextStyle(
