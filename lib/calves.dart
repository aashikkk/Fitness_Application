...
class calvesscreen extends StatefulWidget {
  const calvesscreen({super.key});

  @override
  State<calvesscreen> createState() => _calvesscreenState();
}

class _calvesscreenState extends State<calvesscreen> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(
      'https://res.cloudinary.com/dg6kx8vbj/video/upload/c_fit,w_1419/v1684687334/vecteezy_barbell-seated-on-knee-calve-raises-fitness-exercise-workout_23272680_336_pmay5y.mp4',
    ));
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: getwidth(context),
              child: Text(
                'Calf raises can help you build larger calf muscles. Calf raises target the muscles on the back of your lower legs, specifically the gastrocnemius muscle that runs down your leg and the soleus muscle near your Achilles tendon.07',
                style: TextStyle(
