              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => cablecurlscreen()));
                },
                child: Container(
                  child: Center(
                    child: Row(
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => dumbellbicepscreen()));
                },
                child: Container(
                  child: Center(
                    child: Row(
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => seatedcurlscreen()));
                },
                child: Container(
                  child: Center(
                    child: Row(
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => dipsmachinescreen()));
                },
                child: Container(
                  child: Center(
                    child: Row(
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => dipsbenchscreen()));
                },
                child: Container(
                  child: Center(
                    child: Row(
