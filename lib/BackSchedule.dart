          ...
          IconButton(
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => back_workout()));
              },
                ...
                children: [
                  ...
                  Container(
                    child: CircleAvatar(
                      backgroundColor: Colors.black,
                      backgroundImage:
                          AssetImage("assets/images/latpulldown.png"),
                      radius: 35,
                    ),
                    margin: EdgeInsets.only(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (latsweightController.text
                                              .toString()
                                              .isEmpty ||
                                          latssetsController.text
                                              .toString()
                                              .isEmpty ||
                                          latsrepsController.text
                                              .toString()
                                              .isEmpty) {
                                        ...
                                        ref
                                            ...
                                            .update({
                                          'lats Pulldown weights':
                                              latsweightController.text
                                                  .toString(),
                                          'lats Pulldown sets':
                                              latssetsController.text
                                                  .toString(),
                ...
                children: [
                  ...
                  Container(
                    child: CircleAvatar(
                      backgroundColor: Colors.black,
                      backgroundImage:
                          AssetImage("assets/images/seatedrow.png"),
                      radius: 35,
                    ),
                    margin: EdgeInsets.only(
                        top: getheight(context) * 0.01,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (seatedrowweightController.text
                                              .toString()
                                              .isEmpty ||
                                          seatedrowsetsController.text
                                              .toString()
                                              .isEmpty ||
                                          seatedrowrepsController.text
                                              .toString()
                                              .isEmpty) {
                                        toast('All Fields are required');
                                      } else {
                                        ref
                                            .child(
                                                UserRecords().Userid.toString())
                                            .update({
                                          'Seated Cable weights':
                                              seatedrowweightController.text
                                                  .toString(),
                                          'Seated Cable  sets':
                                              seatedrowsetsController.text
                                                  .toString(),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (deadliftweightController.text
                                              .toString()
                                              .isEmpty ||
                                          deadliftsetsController.text
                                              .toString()
                                              .isEmpty ||
                                          deadliftrepsController.text
                                              .toString()
                                              .isEmpty) {
                                        toast('All Fields are required');
                                      } else {
                ...
                children: [
                  ...
                  Container(
                    child: CircleAvatar(
                      backgroundColor: Colors.black,
                      backgroundImage:
                          AssetImage("assets/images/armpullover.png"),
                      radius: 35,
                    ),
                    margin: EdgeInsets.only(
                        top: getheight(context) * 0.01,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (bentarmweightController.text
                                              .toString()
                                              .isEmpty ||
                                          bentarmsetsController.text
                                              .toString()
                                              .isEmpty ||
                                          bentarmrepsController.text
                                              .toString()
                                              .isEmpty) {
                                        toast('All Fields are required');
                                      } else {
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (pullupsweightController.text
                                              .toString()
                                              .isEmpty ||
                                          pullupssetsController.text
                                              .toString()
                                              .isEmpty ||
                                          pullupsrepsController.text
                                              .toString()
                                              .isEmpty) {
                                        toast('All Fields are required');
                                      } else {
