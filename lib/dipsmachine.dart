...
void main() => runApp(const dipsmachine());

class dipsmachine extends StatelessWidget {
  const dipsmachine({super.key});
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      ...
      home: dipsmachinescreen(),
    );
  }
}

class dipsmachinescreen extends StatefulWidget {
  const dipsmachinescreen({super.key});

  @override
  State<dipsmachinescreen> createState() => _dipsmachinescreenState();
}

class _dipsmachinescreenState extends State<dipsmachinescreen> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(
      'https://res.cloudinary.com/dg6kx8vbj/video/upload/c_fit,w_1419/v1684682374/vecteezy_triceps-dip-machine-fitness-exercise-workout-animation-video_19903018_537_j63k49.mp4',
    ));
