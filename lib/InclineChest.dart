...
void main() => runApp(const inclinechest());

class inclinechest extends StatelessWidget {
  const inclinechest({super.key});
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      ...
      home: inclinechestscreen(),
    );
  }
}

class inclinechestscreen extends StatefulWidget {
  const inclinechestscreen({super.key});

  @override
  State<inclinechestscreen> createState() => _inclinechestscreenState();
}

class _inclinechestscreenState extends State<inclinechestscreen> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(
      'https://res.cloudinary.com/dg6kx8vbj/video/upload/c_fit,w_1023/v1683982919/workouts/Chest/incline_dumbell_press_p3qtwh.mp4',
    ));
