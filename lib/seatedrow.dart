...
void main() => runApp(const seatedrow());
...
class seatedrow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      ...
      home: seatedrowscreen(),
    );
  }
}

class seatedrowscreen extends StatefulWidget {
  const seatedrowscreen({super.key});

  @override
  State<seatedrowscreen> createState() => _seatedrowscreenState();
}

class _seatedrowscreenState extends State<seatedrowscreen> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(
      'https://res.cloudinary.com/dg6kx8vbj/video/upload/c_fit,w_1419/v1684059900/vecteezy_cable-seated-supine-grip-row-fitness-exercise-workout_23550650_40_llppw0.mp4',
    ));
