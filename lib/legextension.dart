...
void main() => runApp(const legsextension());

class legsextension extends StatelessWidget {
  const legsextension({super.key});
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      ...
      home: legsextensionscreen(),
    );
  }
}

class legsextensionscreen extends StatefulWidget {
  const legsextensionscreen({super.key});

  @override
  State<legsextensionscreen> createState() => _legsextensionscreenState();
}

class _legsextensionscreenState extends State<legsextensionscreen> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(
      'https://res.cloudinary.com/dg6kx8vbj/video/upload/c_fit,w_1419/v1684687263/vecteezy_seated-leg-curl-machine-fitness-exercise-workout-animation_20938639_595_xqbfy0.mp4',
    ));
