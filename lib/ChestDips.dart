...
void main() => runApp(const chestdips());

class chestdips extends StatelessWidget {
  const chestdips({super.key});
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      ...
      home: chestdipsscreen(),
    );
  }
}

class chestdipsscreen extends StatefulWidget {
  const chestdipsscreen({super.key});

  @override
  State<chestdipsscreen> createState() => _chestdipsscreenState();
}

class _chestdipsscreenState extends State<chestdipsscreen> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(
      'https://res.cloudinary.com/dg6kx8vbj/video/upload/c_fit,w_1419/v1683983106/workouts/Chest/chest_dips_ooq2zy.mp4',
    ));
