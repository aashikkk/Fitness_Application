...
void main() => runApp(const chestmachine());

class chestmachine extends StatelessWidget {
  const chestmachine({super.key});
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      ...
      home: chestmachinescreen(),
    );
  }
}

class chestmachinescreen extends StatefulWidget {
  const chestmachinescreen({super.key});

  @override
  State<chestmachinescreen> createState() => _chestmachinescreenState();
}

class _chestmachinescreenState extends State<chestmachinescreen> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(
      'https://res.cloudinary.com/dg6kx8vbj/video/upload/c_fit,w_1419/v1683983329/workouts/Chest/machine_press_zkmpnu.mp4',
    ));
