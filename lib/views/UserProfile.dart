...
import 'package:fitnessapp/auth/LoginPage.dart';
          ...
          child: TextButton(
            onPressed: () {
              Navigator.pushAndRemoveUntil(
                  context,
                  MaterialPageRoute(
                      builder: (context) => loginpage(usernameController: '')),
                  (route) => false);
            },
            child: Text(
              'Sign Out',
            ...
            children: [
              Container(
                ...
                child: FirebaseAnimatedList(
                  query: ref
                      .orderByChild('Email')
                      .equalTo(_auth.currentUser?.email.toString()),
              ...
              Container(
                ...
                child: ListView(
                  children: [
                    ...
                    Text(
                      'Manage App Account information',
                      style: TextStyle(
