import 'package:fitnessapp/reversefly.dart';
import 'package:fitnessapp/shoulderpress.dart';
import 'package:fitnessapp/sideraises.dart';
import 'package:fitnessapp/uprightrow.dart';
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => sideraisesscreen()));
                },
                child: Container(
                  child: Center(
                    child: Row(
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => frontraisesscreen()));
                },
                child: Container(
                  child: Center(
                    child: Row(
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => reverseflyscreen()));
                },
                child: Container(
                  child: Center(
                    child: Row(
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => uprightrowscreen()));
                },
                child: Container(
                  child: Center(
                    child: Row(
