...
import 'package:fitnessapp/WorkoutIntermediate.dart';
import 'package:fitnessapp/WorkoutsSelect.dart';
import 'package:fitnessapp/firebase_toast.dart';
import 'package:fitnessapp/set_height_and_width.dart';
import 'package:fitnessapp/userpage.dart';
import 'package:fitnessapp/workoutadvanced.dart';
                      ...
                      child: Container(
                        ...
                        child: CircleAvatar(
                          child: FirebaseAnimatedList(
                            query: ref
                                .orderByChild('Email')
                                .equalTo(auth.currentUser?.email.toString()),
                            itemBuilder: (context, snapshot, animation, index) {
                              return Container(
                                height: getheight(context) * 0.08,
                                // These are not working within avatar
                                child: Row(
                                  children: [
                                    Text(
                                      snapshot
                    ...
                    IconButton(
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => workoutsselect()));
                      },
                      icon: Icon(
                    ...
                    IconButton(
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => schedule_screen()));
                      },
