import 'package:fitnessapp/BackSchedule.dart';
import 'package:fitnessapp/ChestSChedule.dart';
import 'package:fitnessapp/ShoulderSchedule.dart';
import 'package:fitnessapp/UserRecordManager.dart';
import 'package:fitnessapp/firebase_toast.dart';
        ...
        child: Column(
          children: [
            ...
            InkWell(
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => chest_schedule()));
              },
              child: Container(
            ...
            InkWell(
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => back_schedule()));
              },
              child: Container(
                decoration: BoxDecoration(
                    image: DecorationImage(
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => shoulder_schedule()));
              },
              child: Container(
                decoration: BoxDecoration(
                    image: DecorationImage(
            ...
            InkWell(
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => arms_schedule()));
              },
              child: Container(
                decoration: BoxDecoration(
                    image: DecorationImage(
            ...
            InkWell(
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => legs_schedule()));
              },
              child: Container(
                decoration: BoxDecoration(
                    image: DecorationImage(
            ...
            InkWell(
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => abs_schedule()));
              },
              child: Container(
                decoration: BoxDecoration(
                    image: DecorationImage(
