...
class _squatsscreenState extends State<squatsscreen> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(
      'https://res.cloudinary.com/dg6kx8vbj/video/upload/c_fit,w_1419/v1684686749/vecteezy_barbell-full-squat-fitness-exercise-workout-animation-video_20938649_840_hp9hyi.mp4',
    ));
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              width: getwidth(context),
              child: Text(
                'One of the main benefits of squats with weights is to add strength to your glutes, helping to tone and tighten your glute muscles. That is why many do squat exercises in order to work on their shape.',
                style: TextStyle(
